...
export function Landing() {
	...
	return (
		<>
			<header className="px-6 py-3 h-fit flex flex-row items-center justify-between bg-secondary">
				<h1 className="text-3xl">EzzHost</h1>
				<ModeToggle />
			</header>
					...
					<CardContent>
						<div className="space-y-4">
							...
							<Button
								...
								type="submit"
							>
								{deployed ? "Deployed" : uploadId ? `Deploying (${uploadId})` : uploading ? "Uploading..." : "Upload"}
							</Button>
						</div>
					</CardContent>
				</Card>
					...
					<Card className="w-full max-w-md mt-8">
						...
						<CardContent>
							<div className="space-y-2">
								...
								<Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.host.com/index.html`} />
							</div>
							<br />
							<Button className="w-full" variant="outline">
								<a href={`http://${uploadId}.host.com/index.html`} target="_blank">
									Visit Website
								</a>
							</Button>
						</CardContent>
